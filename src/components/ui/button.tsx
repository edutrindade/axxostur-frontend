	...
	"inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-bold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
	{
		variants: {
			variant: {
				...
				outline:
					"border-2 border-slate-300 bg-white text-slate-800 shadow-sm hover:bg-slate-50 hover:border-slate-400 hover:text-slate-900 hover:shadow-md",
				secondary:
					"bg-gradient-to-r from-slate-100 to-slate-200 text-slate-800 shadow-sm hover:from-slate-200 hover:to-slate-300 hover:shadow-md",
				ghost:
					"text-slate-700 hover:bg-slate-100 hover:text-slate-900 hover:shadow-sm",
				link:
					"text-blue-700 underline-offset-4 hover:underline hover:text-blue-800 font-semibold",
				premium:
					"bg-gradient-to-r from-purple-600 to-purple-700 text-white shadow-lg hover:from-purple-700 hover:to-purple-800 hover:shadow-xl",
			},
			size: {
