  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50">
      <div className="space-y-6 px-6 md:px-8 py-8">
        ...
        <Card className="border-2 border-blue-100 bg-gradient-to-br from-white via-blue-50/20 to-white shadow-lg">
          <CardHeader className="pb-4 space-y-1">
            ...
            <p className="text-sm text-slate-600">Pesquise por GTIN e obtenha as informações tributárias detalhadas</p>
          </CardHeader>
